...
| --- | ---------------------------------------------------- | ------- | ---------------------------- |
| 3   | Final sidebar IA                                     | MISSING |                              |
| 4   | Global shell / real top bar (P6-16)                  | DONE    | `phase6-topbar.spec.ts`      |
| 5   | English default customer language                    | MISSING |                              |
...
| 33  | Publishing (Queue / Published / Failed / Accounts)   | MISSING |                              |
...
| 44  | Settings organisation                                | MISSING |                              |
| 45  | Team                                                 | MISSING |                              |
