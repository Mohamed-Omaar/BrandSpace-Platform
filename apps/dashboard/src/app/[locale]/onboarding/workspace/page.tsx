...
import { countryOptions, DEFAULT_BILLING_CURRENCY, timeZoneOptions } from '@brandspace/shared';
import {
  currentEnvironment,
  getCustomerAuth,
  getSessionToken,
 ...
 * The first workspace.
 *
 * WHAT THIS PAGE IS FOR: collecting the customer's workspace identity facts —
 * country, interface language and timezone. Billing currency is deliberately
 * hidden from this form and supplied as the product USD default.
 *
 ...
 *
 * COUNTRY IS NOT A PAYMENT ROUTE. Every ISO country is available here; checkout
 * later decides whether a configured provider can charge in that market.
 */
